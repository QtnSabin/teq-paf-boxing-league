      ...
      <CardContent className='pb-0'>
        <Accordion type="single" collapsible className={styles.Accordion}>
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              <ul className={styles.list}>
                <li>Pour participer à un combat, il faut au préalable avoir rejoin la Teq-Paf Boxing League. Si ce n'est pas encore fait, rendez-vous sur la page d'acceuil et cliquer sur <strong>Je souhaite rejoindre la ligue</strong>.</li>

                <li>Les inscriptions sont limitées à <strong>1 combat maximum par semaine</strong>. Pour s’inscrire, il vous suffit d’envoyer un message à <strong><a href="https://lifeinvader.storylife.fr/u/rhyseverhart/home" target='_blank' style={{ textDecorationLine: 'underline' }}>Rhys Everhart</a></strong> sur le Life Invader ainsi qu’un virement de $3000 ($2000 si sponsorisé) à l'association (iban: ???). Votre inscription ne sera validée qu’une fois le virement effectué.</li>

                <li><strong>Attention :</strong> les inscriptions seront <strong>clôturées 3 jours avant</strong> la date des combats.</li>

                <li>Il est possible d’annuler un combat. Pour cela, il faudra prévenir avant la cloturation des inscriptions, soit <strong>3 jours</strong> avant la date du combat. Pour cela, il vous suffit d'envoyer un message sur le Life Invader à <strong><a href="https://lifeinvader.storylife.fr/u/rhyseverhart/home" target='_blank' style={{ textDecorationLine: 'underline' }}>Rhys Everhart</a></strong>. Lorsque vous prévenez dans le délais autorisé, aucune pénalité ne vous sera appliquée et la somme d'inscription vous sera rendu. Cependant, une fois les inscriptions cloturées, cela sera comptabilisé comme un forfait et donc une défaite. Il vous sera impossible de récupérer les frais de participation. Si jamais vous ne nous prévené pas de votre absence, une pénalité de <strong>-2</strong> points vous sera appliqué. Lorsque des annulations ont lieu, nous nous efforçons de proposer un nouveau combat de remplacement. Si cela n’est pas possible, le combattant censé combattre contre la personne qui a annulé sera désigné automatiquement vainqueur au même titre que si le combat avait eu lieu.</li>
              </ul>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-7">
            ...
            <AccordionContent>
              <ul className={styles.list}>
                <li>Les sponsors peuvent être des entreprises, des commerces indépendants, des ordanisations publiques... Devenir sponsor est possible à partir du moment ou vous disposez d'une image public à promouvoir. Pour toutes les demandes de sponsorisation, veuillez contacter <strong><a href="https://lifeinvader.storylife.fr/u/rhyseverhart/home" target='_blank' style={{ textDecorationLine: 'underline' }}>Rhys Everhart</a></strong> sur le Life Invader pour obtenir toutes les informations.</li>
